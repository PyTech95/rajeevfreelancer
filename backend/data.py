...
SERVICES = [
    ...
    },
    {
        ...
        "keyword": "software development freelancer",
        "icon": "Terminal",
    },
    {
...
COUNTRIES = {
    ...
    "uk": {"name": "UK", "region": "Europe", "cities": ["London", "Manchester", "Birmingham", "Leeds", "Bristol", "Edinburgh", "Glasgow", "Liverpool", "Sheffield", "Newcastle", "Nottingham", "Southampton", "Cardiff", "Belfast", "Leicester", "Brighton", "Oxford", "Cambridge", "Reading"]},
    ...
    "germany": {"name": "Germany", "region": "Europe", "cities": ["Berlin", "Munich", "Frankfurt", "Hamburg", "Cologne", "Stuttgart", "Düsseldorf", "Leipzig", "Dortmund", "Essen", "Bremen", "Dresden", "Hannover", "Nuremberg", "Bonn", "Heidelberg"]},
