      ...
      >
        <div className="mx-auto max-w-[1400px] px-5 md:px-10 flex items-center justify-between">
          <Link to="/" data-testid="nav-logo" aria-label="Rajeev Freelancer — home" className="group flex items-center gap-2.5">
            <img
              src="https://customer-assets-gfyr7b9c.emergentagent.net/job_rajeev-app/artifacts/0zkv66rh_image.png"
            ...
            >
              <div className="flex items-center justify-between px-6 py-5 border-b border-line">
                <span className="flex items-center gap-2.5">
                  <img src="https://customer-assets-gfyr7b9c.emergentagent.net/job_rajeev-app/artifacts/0zkv66rh_image.png" alt="Rajeev Freelancer" className="h-9 w-9 rounded-full object-cover border border-line" />
