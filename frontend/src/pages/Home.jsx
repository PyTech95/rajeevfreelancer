...
import { NcrSection } from "@/components/NcrSection";
...
const ABOUT_IMG = "https://customer-assets-gfyr7b9c.emergentagent.net/job_rajeev-app/artifacts/0zkv66rh_image.png";
...
const HOME_FAQS = [
  { q: "Who is Rajeev Freelancer?", a: "Rajeev is an app developer, website development expert and SEO/digital-marketing consultant with 12+ years of experience (ex-IOG, Accenture, Google). He builds websites, apps and custom software and runs SEO, GEO, AI automation and WhatsApp/SMS marketing for businesses in 27+ countries." },
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-5 md:px-10 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.7 }} className="mt-7 max-w-xl text-base md:text-lg text-ink/70 leading-relaxed">
              I'm an app developer, website development expert & SEO marketing consultant with 12+ years turning websites, apps, SEO, digital marketing and AI automation into revenue — for businesses in 200+ locations worldwide.
            </motion.p>
