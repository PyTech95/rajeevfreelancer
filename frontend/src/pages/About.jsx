...
export default function About() {
  ...
  return (
    <div>
      <Seo
        title="About Rajeev — App Developer, Website Development & SEO Marketing Consultant"
        description="12+ years in production. Ex-IOG, Accenture and Google. Six years independent. Meet Rajeev — app developer, website development expert & SEO/digital marketing consultant in Delhi NCR, available worldwide."
        path="/about"
        jsonLd={jsonLd}
      />
      ...
      <section className="mx-auto max-w-[1400px] px-5 md:px-10 pb-20 grid lg:grid-cols-12 gap-10 items-start">
        <Reveal className="lg:col-span-5">
          <img src={ABOUT_IMG} alt="Rajeev, senior freelance engineer and consultant" className="w-full rounded-2xl border border-line object-cover aspect-[4/5]" />
        </Reveal>
