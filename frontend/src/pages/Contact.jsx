  ...
  return (
    <div>
      <Seo
        ...
        description="Book a free consultation with Rajeev — app developer, website development & SEO marketing consultant. WhatsApp, email or the form. Average response under 30 minutes."
        path="/contact"
      />
